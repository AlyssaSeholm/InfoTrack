        ...
        <>
            <article className="prose">
              ...
              <h2 id="component2">Form Input</h2>
                ...
                <InputText type="text" defaultValue={"input value"} updateType="first_name" containerStyle="mt-3" labelTitle="Label Title" updateFormValue={updateFormValue} labelStyle={null} inputStyle={'primary'} placeholder={null}/>
