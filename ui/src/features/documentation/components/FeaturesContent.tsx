        ...
        <>
            <article className="prose">
              ...
              <h2 id="feature2">Left Sidebar</h2>
                  <p>
                      This is main internal navigation (for pages that will come after login only), all sidebar menu items with their icons are present in <span className="badge mt-0 mb-0 badge-ghost">/routes/navbar.tsx</span>  file, while  path and page components mapping are respectively present in <span className="badge mt-0 mb-0 badge-ghost">/routes/index.js</span> file.
                    </p>
            ...
            <h2 id="feature3">Add New Page</h2>
                ...
                <p className='mt-4'>All <span className='font-semibold'>protected routes</span> are present in <span className="badge mt-0 mb-0 badge-ghost">/routes/navbar.tsx</span> file</p>

                <ul className='mt-0'>
                        <li>Create your page inside <span className="badge mt-0 mb-0 badge-ghost">/pages/protected</span> folder</li>
                        <li>Add your new routes in <span className="badge mt-0 mb-0 badge-ghost">/routes/navbar.tsx</span>, this will show your new page in sidebar</li>
              ...
              <h2 id="feature4">Right Sidebar</h2>
                    <div>
                        ...
                        <ul>
                          ...
                          <li>Create new variable in <span className="badge mt-0 mb-0 badge-ghost">/utilities/Constantss.js</span> file under RIGHT_DRAWER_TYPES variable</li>
              ...
              <h2 id="feature6">Modal</h2>
                  <div>
                        ...
                        <ul>
                          ...
                          <li>Create new variable in <span className="badge mt-0 mb-0 badge-ghost">/utilities/Constantss.js</span> file under MODAL_BODY_TYPES variable</li>
