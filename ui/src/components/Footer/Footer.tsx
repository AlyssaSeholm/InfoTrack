...
// import CatALogLogo from '../../../src/assets/images/CatALogLogo.png'; // 'src\assets\images\CatALog_Logo.png';
// import styles from './Footer.module.css';
// import {default as CatALogLogo} from '../../assets/images/CatALogLogo.png';
// import images from '../../assets/images/images.ts';
// import logo from '../../assets/images/images.ts';
// import logggo from '@/assets/images/logo.png';
// import CatALogLogo from '@/assets/images/CatALog_Logo.png';
  ...
  return (
    <>
      <footer className="footer footer-center p-10 bg-primary text-primary-content">
        <aside>
        {/* <img key={logo.id} src={logo.src} title={logo.title} alt={logo.description} /> */}
        {/* <img src={CatALogLogo} alt="My Image" /> */}
          {/* <img className="mask mask-hexagon-2" src={require('../../assets/logo.png')} alt="CatALog Logo" /> */}
          {/* <img src={process.env.PUBLIC_URL + '/logo.png'} alt="My Image" /> */}
          <img src={'/logo.png'} alt="My Image" width="45" height="45" />
          ...
          <p className="font-bold">
            Cat-A-Log SEO Solutions Ltd. <br/>Providing meow-velous SEO data to help cat-apult your business to the top!
          </p> 
          <p>Copyright © 2024 - All rights reserved - purrhaps</p>
        </aside> 
        <nav>
